...
public sealed class MessageExceptionAssertion : IExceptionAssertion
{
    ...
    public static MessageExceptionAssertion Equals(string expectedMessage) => new(expectedMessage, MessageExceptionAssertionType.Equals);

    public static MessageExceptionAssertion Contains(string expectedMessage) => new(expectedMessage, MessageExceptionAssertionType.Contains);

    public static MessageExceptionAssertion MatchesRegex(string expectedMessage) => new(expectedMessage, MessageExceptionAssertionType.MatchesRegex);
}
